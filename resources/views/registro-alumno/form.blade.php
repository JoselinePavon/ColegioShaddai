<div class="container mt-5">
    <form method="POST" action="{{ route('registro-alumnos.store') }}">
        ...
        <div class="row">
            <div class="col-md-6">
                <h3 class="mb-3">Datos del Estudiante</h3>
                <div class="mb-3">
                    <label for="studentName" class="form-label"><i class="bi bi-person-fill"></i> Nombres</label>
                ...
                <div class="mb-3">
                    <label for="studentName" class="form-label"><i class="bi bi-person-fill"></i> Apellidos</label>
                ...
                <div class="mb-3">
                    <label for="guardianRelation" class="form-label"><i class="bi bi-people-fill"></i> Genero</label>
                ...
                <div class="mb-3">
                    <label for="studentDOB" class="form-label"><i class="bi bi-calendar-date"></i> Edad</label>
                ...
                <div class="mb-3">
                    <label for="studentDOB" class="form-label"><i class="bi bi-calendar-date"></i> Fecha de nacimiento</label>
            ...
            <div class="col-md-6">
                <h3 class="mb-3">Datos del Encargado</h3>
                <div class="mb-3">
                    <label for="guardianName" class="form-label"><i class="bi bi-person-fill"></i> Nombre completo</label>
                ...
                <div class="mb-3">
                    <label for="studentAddress" class="form-label"><i class="bi bi-house-door-fill"></i> Dirección</label>
                ...
                <div class="mb-3">
                    <label for="guardianPhone" class="form-label"><i class="bi bi-telephone-fill"></i> Teléfono</label>
                ...
                <div class="mb-3">
                    <label for="guardianPhone" class="form-label"><i class="bi bi-telephone-fill"></i> Teléfono Alternativo</label>
                ...
                <div class="mb-3">
                    <label for="guardianPhone" class="form-label"><i class="bi bi-telephone-fill"></i> Telefono de Emergencia</label>
