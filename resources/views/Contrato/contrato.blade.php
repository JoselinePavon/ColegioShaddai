...
@section('content')
    ...
    <div class="clause">
        ...
        <p style="text-align: justify;">El servicio educativo convenido en este contrato será válido para el ciclo escolar 2026
